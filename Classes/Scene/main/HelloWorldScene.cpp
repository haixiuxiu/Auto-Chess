...
bool HelloWorld::init()
{
    ...
    ////////////////////////
    countdownLabel = Label::createWithTTF("29", "fonts/arial.ttf", 32);
...
void HelloWorld::Waiting() {
    this->scheduleOnce(CC_CALLBACK_1(HelloWorld::startGame1, this), 30.0f, "startGame1");
...
void HelloWorld::startGame1(float ft) {
    ...
    this->scheduleOnce(CC_CALLBACK_1(HelloWorld::startGame2, this), 5.0, "startGame2");
...
void HelloWorld::resetGame(float dt) {
  ...
  enableMouseEvents();
   myMiniHero->setPosition(Vec2(120, 120));
    // 延时一段时间后开始新的一局
    this->scheduleOnce(CC_CALLBACK_1(HelloWorld::startGame1, this), 30.0f, "restartGame");
}
